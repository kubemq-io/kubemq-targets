	...
	tests := []struct {
	...
	}{
		{
			...
			cfg: config.Spec{
				...
				Properties: map[string]string{
					"connection":                      "root:password@(localhost:3306)/test?charset=utf8&parseTime=True&loc=Local",
		...
		},
		{
			...
			cfg: config.Spec{
				...
				Kind: "stores.singlestore",
				Properties: map[string]string{
					"connection":                      "root:password@(localhost:5678)/test?charset=utf8&parseTime=True&loc=Local",
					"max_idle_connections":            "",
					"max_open_connections":            "",
					"connection_max_lifetime_seconds": "",
				},
