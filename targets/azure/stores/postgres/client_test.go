...
func getTestStructure() (*testStructure, error) {
	t := &testStructure{}
	dat, err := ioutil.ReadFile("./../../../../credentials/azure/stores/postgres/connectionString.txt")
	if err != nil {
		return nil, err
	}
	t.connectionString = string(dat)
	dat, err = ioutil.ReadFile("./../../../../credentials/azure/stores/postgres/connectionStringBadPort.txt")
	if err != nil {
		return nil, err
	}
