...
func getTestStructure() (*testStructure, error) {
	t := &testStructure{}
	dat, err := ioutil.ReadFile("./../../../../credentials/azure/stores/mysql/connectionString.txt")
	if err != nil {
		return nil, err
	}
	t.connectionString = string(dat)
	dat, err = ioutil.ReadFile("./../../../../credentials/azure/stores/mysql/connectionStringBadPort.txt")
	if err != nil {
		return nil, err
	}
